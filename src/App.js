      ...
      <div className="App-header">
        <div className="intro">
          ...
          <div className="description">
            ...
            <p>Currently, I'm working on an app, <a href="https://github.com/matthewgaim/Stonks" class='stonksLink'>Stonks</a>, where people can practice trading with fake money, aka paper trading.</p>
